...
$(()=>{ /////// JQB ///////
    ...
    .blur(function(){
        ...
        *****************************************/
        ...
        // console.log("아이디검사결과:",vReg(cv,cid));
            if(!vReg(cv,cid)){ // !(not) 반대로 들어감(false일때)
                $(this).siblings(".msg")
        ...
        *****************************************/
        ...
        // console.log("비번검사결과:",vReg(cv,cid));
        ...
        *****************************************/
        ...
        // console.log("비번확인검사결과:",vReg(cv,cid));
 ...
 $("#email1,#email2").on("keyup",function(){
    ...
    // 이메일 뒷주소로 변경함!
    if(seleml.val()==="free") backeml1 = eml2.val();
