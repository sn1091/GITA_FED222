...
// 등장액션 대상위치(배열변수)
const scPos=[];
// 화면높이값 기준 등장액션 위치 보정변수
const winH = window.innerHeight/3 * 2;

//////////////////////// 로드구역 //////////////////////
window.addEventListener("DOMContentLoaded",()=>{

    // 로그인, 회원가입, 갤러리 html메뉴코드 넣기
    // html 태그 코드 만들기
    let hcode=`
    ...
    // 위로가기 버튼 클릭시 부드러운 스크롤 변수 pos업데이트!
    // tbtn.onclick = () => {
    //     pos =0;
    //     return false;
    // }
    // 위로가기 버튼 클릭시 -> 제이쿼리로 부드러운 이동!
    // 부드러운 스크롤 변수 pos업데이트
    $(".tbtn").click(()=>{
        console.log("dk")
        // 제이쿼리 스크롤 애니메이션
...
window.addEventListener('scroll', ()=> {
    ...
    // console.log("스위2:",document.scrollingElement.scrollTop);
    // console.log("스위3:",document.documentElement.scrollTop);
    // console.log("스위4:",document.querySelector("html").scrollTop);
    ...
    // 스크롤 시 등장요소 위치값 개수 만큼 scAction 함수 호출!
